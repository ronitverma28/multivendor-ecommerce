...
public interface ProductRepository extends JpaRepository<Product, Long> {
    @Query("""
            ...
            """)
    Page<Product> searchProducts(@Param("title") String title, @Param("description") String description, @Param("color") String color, @Param("sizes") String sizes, @Param("minPrice") Integer minPrice, @Param("maxPrice") Integer maxPrice, Pageable pageable);
